  ...
  return (
    <div>
      <div className=' grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 my-5'>
        <div className='project border shadow-2xl  shadow-amber-500 rounded-2xl flex flex-col justify-center items-center gap-5 hover:scale-105 hover:shadow-purple-500 overflow-hidden'>
          <img
            src={flightImage}
            alt='image'
          />
          <h2 className='text-2xl font-bold'>Airline Reservation System</h2>
          <p className='p-2 m-1'>
            In this project, I tried to make a realistic website to search the flights on particular date, book the flight tickets, get the tickets, etc
             ...
             <button className=' bg-blue-900 text-white text-xl py-5 px-10 rounded-2xl mx-1 my-6 align-middle '>
             Github</button>
            </a>
